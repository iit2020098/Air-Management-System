...
public class HomeScreen extends javax.swing.JFrame {
    ...
    public HomeScreen() {
        ...
        recipients.add("kunalprajapati544@gmial.com");
        recipients.add("iit2020099@iiita.ac.in");
...
//    }
                    ...
                    if(levelsPlace.equals(places.get(0).name)){
                        ...
                        switch(aqi){
                            case "Very Low":
                                ...
                                break;
                            case "Low":
                                place0aqi.setForeground(new Color(103, 207, 17));
                                break;
                            case "Medium":
                                place0aqi.setForeground(new Color(206, 146, 9));
                                break;
                            case "High":
                            ...
                            case "Very High":
                                ...
                                place0aqi.setForeground(new Color(196, 90, 11));
                                break;
                        }
                    }
                    ...
                    if(levelsPlace.equals(places.get(1).name)){
                        ...
                        switch(aqi){
                            case "Very Low":
                                ...
                                break;
                            case "Low":
                                place1aqi.setForeground(new Color(103, 207, 17));
                                break;
                            case "Medium":
                                place1aqi.setForeground(new Color(206, 146, 9));
                                break;
                            case "High":
                                if(send.isSelected() == true){
                                    alert = true;
                            ...
                            case "Very High":
                                ...
                                place1aqi.setForeground(new Color(196, 90, 11));
                                break;
                        }
                    }
                    ...
                    if(levelsPlace.equals(places.get(2).name)){
                        ...
                        switch(aqi){
                            case "Very Low":
                                ...
                                break;
                            case "Low":
                                place2aqi.setForeground(new Color(103, 207, 17));
                                break;
                            case "Medium":
                            ...
                            case "Very High":
                                ...
                                place2aqi.setForeground(new Color(212, 94, 8));
                                break;
                        }
                    }
                }
    ...
    private void initComponents() {
        ...
        place0aqi.setForeground(new java.awt.Color(110, 234, 10));
        ...
        place1aqi.setForeground(new java.awt.Color(110, 234, 10));
        ...
        jPanel7.setBackground(new java.awt.Color(59, 128, 3));
        ...
        jPanel9.setBackground(new java.awt.Color(59, 128, 3));
